...
//            inputStream.close();
    ...
    class FilterStream_학습_테스트 {
        ...
        void 필터인_BufferedInputStream를_사용해보자() throws IOException {
            ...
            final InputStream inputStream = new ByteArrayInputStream(text.getBytes()); // ByteArrayInputStream 필터에 연결?
            final InputStream bufferedInputStream = new BufferedInputStream(inputStream); // BufferedInputStream필터에 연결
