...
public class HttpResponse {
    ...
    public static HttpResponse of(final StatusCode statusCode, final ContentType contentType, final String requestUrl) throws URISyntaxException {
    ...
    public static HttpResponse of(final StatusCode statusCode, final ContentType contentType, final Location location) throws URISyntaxException {
    ...
    public static HttpResponse of(final StatusCode statusCode, final ContentType contentType, final Location location,
                                  final Cookie cookie) throws URISyntaxException {
        final String responseBody = new String(Objects.requireNonNull(readAllFile(location.toString())), UTF_8);
