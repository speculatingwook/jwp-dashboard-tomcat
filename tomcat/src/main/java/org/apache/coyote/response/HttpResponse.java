...
public class HttpResponse {
    ...
    public static HttpResponse of(final StatusCode statusCode, final ContentType contentType, final String location) throws URISyntaxException {
    ...
    public static HttpResponse of(final StatusCode statusCode, final ContentType contentType, final String location,
                                  final String requestUrl) throws URISyntaxException {
